...
1.10.4 (2026-06-16)
-------------------
* Use logger.warning(), f-string , super() and Qt6 fixes (backport `#59 <https://github.com/ros-visualization/rqt_publisher/issues/59>`_) (`#60 <https://github.com/ros-visualization/rqt_publisher/issues/60>`_)
